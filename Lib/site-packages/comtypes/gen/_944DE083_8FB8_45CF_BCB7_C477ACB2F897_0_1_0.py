...
__all__ = [
    'UIA_DropTargetDropTargetEffectPropertyId', 'UIA_WindowPatternId',
    'ToggleState_Off', 'UIA_ToggleToggleStatePropertyId',
    'IUIAutomationMultipleViewPattern', 'IUIAutomationElementArray',
    'AnnotationType_GrammarError', 'UIA_TreeControlTypeId',
    'UIA_IsControlElementPropertyId', 'UIA_ItemContainerPatternId',
    'Off', 'UIA_Window_WindowClosedEventId',
    ...
    'UIA_ChangesEventId', 'AnnotationType_CircularReferenceError',
    'UIA_AriaPropertiesPropertyId', 'UIA_VisualEffectsPropertyId',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_IsHiddenAttributeId', 'UIA_CustomLandmarkTypeId',
    'OrientationType', 'UIA_ProgressBarControlTypeId',
    'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_ComboBoxControlTypeId', 'ZoomUnit_NoAmount',
    'UIA_SelectionItemIsSelectedPropertyId',
    'IUIAutomationEventHandler',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_RangeValueMaximumPropertyId',
    'UIA_FullDescriptionPropertyId', 'ZoomUnit_SmallIncrement',
    'StyleId_Heading9', 'CoalesceEventsOptions_Disabled',
    'UIA_Transform2CanZoomPropertyId',
    'SupportedTextSelection_Multiple',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'NotificationKind_ItemAdded', 'DockPosition_Fill',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'NavigateDirection_NextSibling', 'TextUnit_Character',
    'TextUnit_Word', 'UIA_TablePatternId', 'UIA_DropTargetPatternId',
    'IUIAutomation4', 'UIA_SizePropertyId', 'HeadingLevel6',
    'UIA_TransformCanResizePropertyId', 'UIA_SliderControlTypeId',
    'UIA_TextEdit_TextChangedEventId',
    'UIA_HasKeyboardFocusPropertyId',
    'UIA_AnnotationAuthorPropertyId', 'WindowVisualState_Minimized',
    'UIA_MenuOpenedEventId', 'UIA_AriaRolePropertyId',
    ...
    'UIA_SpreadsheetItemPatternId', 'UIA_RuntimeIdPropertyId',
    'SupportedTextSelection_None', 'UIA_ThumbControlTypeId',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_GridItemRowPropertyId', 'HeadingLevel4',
    'UIA_FontWeightAttributeId', 'IUIAutomationTextChildPattern',
    'RowOrColumnMajor', 'ScrollAmount_SmallIncrement',
    'WindowInteractionState', 'TreeTraversalOptions',
    'UIA_AnnotationTargetPropertyId', 'TreeScope_Ancestors',
    'TextEditChangeType_Composition', 'ProviderOptions',
    'UIA_GridItemRowSpanPropertyId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'TreeScope_Children', 'UIA_MenuModeEndEventId',
    'UIA_TextPatternId', 'IUIAutomationScrollItemPattern',
    'UIA_ActiveTextPositionChangedEventId', 'StyleId_Heading2',
    'UIA_SpreadsheetItemFormulaPropertyId', 'TextUnit_Page',
    'UIA_CaretBidiModeAttributeId', 'UIA_NavigationLandmarkTypeId',
    'NotificationKind', 'UIA_LabeledByPropertyId',
    'WindowInteractionState_Running', 'ScrollAmount_LargeIncrement',
    'UIA_MenuControlTypeId', 'UIA_IsDataValidForFormPropertyId',
    'AutomationElementMode_Full',
    'UIA_IsStylesPatternAvailablePropertyId', 'OrientationType_None',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_Invoke_InvokedEventId', 'TreeScope_Subtree',
    'TextEditChangeType_AutoCorrect',
    'UIA_SelectionActiveEndAttributeId', 'WindowVisualState_Normal',
    'ExpandCollapseState_PartiallyExpanded',
    'ZoomUnit_SmallDecrement', 'TextPatternRangeEndpoint_Start',
    'UIA_ScrollPatternId', 'AnnotationType_FormulaError',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_StructureChangedEventId', 'NavigateDirection',
    'ProviderOptions_NonClientAreaProvider',
    'ToggleState_Indeterminate', 'UIA_MarginBottomAttributeId',
    'UIA_Window_WindowOpenedEventId', 'IUIAutomation6',
    'IUIAutomationSelectionItemPattern',
    'UIA_TableRowHeadersPropertyId', 'AnnotationType_Comment',
    'UIA_Drag_DragCancelEventId', 'UIA_CenterPointPropertyId',
    'UIA_MarginLeadingAttributeId', 'UIA_ExpandCollapsePatternId',
    'AnnotationType_Unknown', 'IUIAutomationOrCondition',
    'TextUnit_Format', 'UIA_ItemStatusPropertyId', 'StyleId_Heading4',
    'NotificationProcessing_All', 'UIA_CulturePropertyId',
    'IUIAutomationDragPattern', 'UIA_InputReachedOtherElementEventId',
    'IUIAutomation', 'ToggleState_On', 'UIA_DescribedByPropertyId',
    'UIA_IsTablePatternAvailablePropertyId', 'UIA_TabControlTypeId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_DragDropEffectPropertyId',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'IUIAutomationElement7', 'UIA_InputReachedTargetEventId',
    ...
    'StyleId_Heading8', 'UIA_RangeValueLargeChangePropertyId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'AutomationElementMode', 'HeadingLevel7', 'UIA_LevelPropertyId',
    'IUIAutomationTransformPattern2', 'IUIAutomationTextRangeArray',
    'ExpandCollapseState', 'UIA_GridColumnCountPropertyId',
    'UIA_DragPatternId', 'UIA_ButtonControlTypeId',
    ...
    'SynchronizedInputType_RightMouseUp', 'IUIAutomation5',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_ProviderDescriptionPropertyId',
    'NotificationKind_ItemRemoved', 'UIA_AnimationStyleAttributeId',
    'UIA_AppBarControlTypeId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_MultipleViewCurrentViewPropertyId', 'CUIAutomation8',
    'TextUnit_Paragraph', 'WindowVisualState',
    'ProviderOptions_ClientSideProvider', 'SynchronizedInputType',
    'UIA_WindowIsTopmostPropertyId', 'IUIAutomationAnnotationPattern',
    'ScrollAmount_LargeDecrement', 'UIA_HeaderControlTypeId',
    'UIA_TitleBarControlTypeId', 'UIA_ValuePatternId',
    'UIA_WindowControlTypeId', 'UIA_CheckBoxControlTypeId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_ToolTipOpenedEventId',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_MenuBarControlTypeId', 'UIA_Selection2ItemCountPropertyId',
    'NavigateDirection_FirstChild',
    'UIA_StrikethroughStyleAttributeId', 'UIA_GridItemPatternId',
    'UIA_VirtualizedItemPatternId',
    'UIA_AnnotationDateTimePropertyId', 'UIA_RangeValuePatternId',
    ...
    'UIA_AutomationIdPropertyId', 'UIA_InputDiscardedEventId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_SayAsInterpretAsMetadataId', 'UIA_TextChildPatternId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_OutlineThicknessPropertyId', 'AnnotationType_Author',
    ...
    'UIA_TableColumnHeadersPropertyId', 'IUIAutomationProxyFactory',
    'UIA_RadioButtonControlTypeId', 'UIA_IsOffscreenPropertyId',
    'IUIAutomationTableItemPattern', 'UIA_IsSubscriptAttributeId',
    'UIA_IsRequiredForFormPropertyId', 'HeadingLevel9',
    'HeadingLevel8', 'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_DragDropEffectsPropertyId', 'IUIAutomationElement8',
    'ScrollAmount_NoAmount', 'AnnotationType_Sensitive',
    'AnnotationType_InsertionChange', 'UIA_AnnotationPatternId',
    'UIA_IsActiveAttributeId', 'UIA_SizeOfSetPropertyId',
    'UIA_LinkAttributeId', 'UIA_SpinnerControlTypeId',
    'AnnotationType_AdvancedProofingIssue',
    'AnnotationType_SpellingError', 'StyleId_Heading1',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_FormLandmarkTypeId', 'AnnotationType_Footer',
    'IUIAutomationNotificationEventHandler', 'UIA_StyleIdAttributeId',
    'UIA_TextControlTypeId', 'IUIAutomationDropTargetPattern',
    'ExpandCollapseState_Collapsed',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_ToolBarControlTypeId', 'UIA_IndentationTrailingAttributeId',
    'UIA_IsKeyboardFocusablePropertyId',
    'IUIAutomationEventHandlerGroup', 'SupportedTextSelection_Single',
    'UIA_TabItemControlTypeId', 'UIA_SearchLandmarkTypeId',
    'UIA_TabsAttributeId', 'SynchronizedInputType_RightMouseDown',
    'UIA_GridRowCountPropertyId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'SynchronizedInputType_KeyUp', 'UIA_BoundingRectanglePropertyId',
    'UIA_ObjectModelPatternId', 'IUIAutomationGridPattern',
    ...
    'UIA_AutomationFocusChangedEventId', 'IUIAutomationNotCondition',
    'UIA_IndentationFirstLineAttributeId', 'UIA_ItemTypePropertyId',
    'IAccessible', 'ZoomUnit_LargeIncrement',
    'UIA_CultureAttributeId', 'UIA_CustomControlTypeId',
    'UIA_WindowCanMinimizePropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_PositionInSetPropertyId', 'UIA_NotificationEventId',
    'IUIAutomationLegacyIAccessiblePattern',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_RangeValueMinimumPropertyId', 'ScrollAmount_SmallDecrement',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_Transform2ZoomMaximumPropertyId', 'IUIAutomationTextRange',
    'IUIAutomationDockPattern', 'UIA_AccessKeyPropertyId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_ListItemControlTypeId', 'UIA_OverlineStyleAttributeId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_RotationPropertyId', 'UIA_AnnotationTypesAttributeId',
    'DockPosition_Top', 'UIA_SelectionPatternId',
    'UIA_ClickablePointPropertyId', 'TreeScope_Parent',
    'IUIAutomationTextPattern', 'NavigateDirection_Parent',
    'UIA_IsContentElementPropertyId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'IUIAutomationRangeValuePattern', 'UIA_MultipleViewPatternId',
    'TextEditChangeType',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'IUIAutomationSelectionPattern', 'UIA_DragGrabbedItemsPropertyId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_TogglePatternId', 'UIA_UnderlineColorAttributeId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_TextFlowDirectionsAttributeId', 'PropertyConditionFlags',
    'IUIAutomationTransformPattern', 'IUIAutomationGridItemPattern',
    'ProviderOptions_ServerSideProvider',
    'IUIAutomationWindowPattern', 'UIA_AcceleratorKeyPropertyId',
    'IUIAutomationElement3', 'UIA_FontNameAttributeId',
    'UIA_HostedFragmentRootsInvalidatedEventId', 'ToggleState',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_IndentationLeadingAttributeId', 'StyleId_BulletedList',
    'IUIAutomationPropertyCondition',
    'NotificationKind_ActionCompleted',
    'CoalesceEventsOptions_Enabled', 'TreeScope_Descendants',
    'UIA_DocumentControlTypeId', 'IUIAutomationElement',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_IsPeripheralPropertyId', 'UIA_IsReadOnlyAttributeId',
    'UIA_TableItemColumnHeaderItemsPropertyId', 'UIA_TextPattern2Id',
    'UIA_StylesPatternId', 'CoalesceEventsOptions',
    'HeadingLevel_None', 'UIA_OrientationPropertyId',
    'UIA_NamePropertyId', 'UIA_HyperlinkControlTypeId',
    'UIA_SeparatorControlTypeId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_FlowsFromPropertyId', 'UIA_MarginTrailingAttributeId',
    'UIA_CustomNavigationPatternId', 'UIA_TreeItemControlTypeId',
    'UIA_DataItemControlTypeId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'IUIAutomationTogglePattern', 'UIA_CaretPositionAttributeId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_TransformPattern2Id', 'UIA_IsItalicAttributeId',
    'ExtendedProperty', 'UIA_CalendarControlTypeId',
    ...
    'UIA_StyleNameAttributeId', 'UIA_MenuModeStartEventId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'IUIAutomationValuePattern', 'UIA_NativeWindowHandlePropertyId',
    'TextUnit_Line', 'UIA_GridPatternId',
    'UIA_DockDockPositionPropertyId', 'TextPatternRangeEndpoint',
    'UIA_TableItemPatternId', 'UIA_ToolTipControlTypeId',
    'UIA_TransformCanMovePropertyId', 'StyleId_Heading5',
    'IUIAutomationExpandCollapsePattern', 'IUIAutomationElement9',
    'AnnotationType_Header', 'IUIAutomationBoolCondition',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_StylesStyleNamePropertyId', 'TextPatternRangeEndpoint_End',
    'StyleId_Quote', 'UIA_Transform2ZoomMinimumPropertyId',
    'HeadingLevel5', 'UIA_ProcessIdPropertyId',
    'StructureChangeType_ChildrenReordered', 'DockPosition_Bottom',
    'UIA_HeaderItemControlTypeId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId', 'Polite',
    'UIA_OverlineColorAttributeId', 'UIA_SplitButtonControlTypeId',
    'UIA_FrameworkIdPropertyId', 'StyleId_Custom',
    'IUIAutomationElement2', 'SynchronizedInputType_LeftMouseUp',
    'IUIAutomationSelectionPattern2',
    'UIA_StrikethroughColorAttributeId',
    'UIA_SayAsInterpretAsAttributeId', 'IUIAutomationTextRange2',
    'IUIAutomationCondition', 'UIA_TransformPatternId',
    'IRawElementProviderSimple',
    'UIA_IsTransformPatternAvailablePropertyId', 'TreeScope_Element',
    'PropertyConditionFlags_IgnoreCase', 'UIA_MenuClosedEventId',
    'ConnectionRecoveryBehaviorOptions',
    'IUIAutomationProxyFactoryEntry', 'UIA_DragIsGrabbedPropertyId',
    'SupportedTextSelection', 'AnnotationType_Highlighted',
    'UIA_IsScrollPatternAvailablePropertyId', 'TreeScope_None',
    'IUIAutomationSpreadsheetItemPattern', 'UIA_TableControlTypeId',
    'UIA_Drag_DragCompleteEventId', 'ScrollAmount',
    'UIA_ScrollItemPatternId', 'StyleId_Heading3',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_ClassNamePropertyId', 'StyleId_Title', 'Assertive',
    'UIA_ScrollBarControlTypeId', 'UIA_DropTarget_DroppedEventId',
    'AnnotationType_EditingLockedChange', 'UIA_IsEnabledPropertyId',
    'AnnotationType_Endnote', 'UIA_FillTypePropertyId',
    'NavigateDirection_PreviousSibling', 'TextUnit_Document',
    'UIA_GridItemColumnPropertyId', 'AnnotationType_DeletionChange',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'AnnotationType_FormatChange', 'UIA_MenuItemControlTypeId',
    'IUIAutomation3', 'UIA_LocalizedLandmarkTypePropertyId',
    'AnnotationType_ConflictingChange', 'UIA_SelectionItemPatternId',
    'StructureChangeType', 'IUIAutomationStylesPattern',
    'UIA_StatusBarControlTypeId', 'TreeTraversalOptions_PostOrder',
    'UIA_IsDragPatternAvailablePropertyId',
    'RowOrColumnMajor_ColumnMajor', 'ExpandCollapseState_Expanded',
    'UIA_ForegroundColorAttributeId', 'UIA_AnnotationTypesPropertyId',
    'AutomationElementMode_None',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_DropTarget_DragEnterEventId',
    'ProviderOptions_UseComThreading', 'IUIAutomationAndCondition',
    'NotificationKind_Other', 'UIA_SelectionSelectionPropertyId',
    'UIA_SpreadsheetPatternId', 'UIA_LocalizedControlTypePropertyId',
    'ExpandCollapseState_LeafNode',
    'StructureChangeType_ChildRemoved',
    'ProviderOptions_OverrideProvider', 'UIA_PaneControlTypeId',
    'IUIAutomationCacheRequest', 'UIA_ControllerForPropertyId',
    'RowOrColumnMajor_RowMajor',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_RangeValueSmallChangePropertyId', 'UIA_SelectionPattern2Id',
    'UIA_TableRowOrColumnMajorPropertyId', 'UiaChangeInfo',
    'DockPosition_None', 'UIA_LayoutInvalidatedEventId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'IUIAutomationTextEditPattern', 'UIA_DockPatternId',
    'ProviderOptions_UseClientCoordinates', 'LiveSetting',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_Text_TextSelectionChangedEventId', 'IUIAutomationElement6',
    'UIA_DropTarget_DragLeaveEventId',
    'UIA_WindowCanMaximizePropertyId', 'UIA_FlowsToPropertyId',
    'UIA_LegacyIAccessibleHelpPropertyId', 'UIA_IsPasswordPropertyId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'AnnotationType_TrackChanges', 'UIA_CapStyleAttributeId',
    'ZoomUnit', 'CUIAutomation', 'UIA_Transform2ZoomLevelPropertyId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'AnnotationType_Footnote',
    'TreeTraversalOptions_LastToFirstOrder',
    'UIA_RangeValueValuePropertyId', 'UIA_MainLandmarkTypeId',
    'UIA_ValueIsReadOnlyPropertyId',
    'IUIAutomationChangesEventHandler',
    'TextEditChangeType_CompositionFinalized', 'StyleId_Normal',
    'TreeScope', 'UIA_IsSuperscriptAttributeId',
    'UIA_BulletStyleAttributeId', 'UIA_SemanticZoomControlTypeId',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_ToolTipClosedEventId', 'UIA_AnnotationObjectsAttributeId',
    'UIA_SystemAlertEventId', 'DockPosition_Left',
    'UIA_IsDockPatternAvailablePropertyId',
    'WindowInteractionState_Closing', 'TreeTraversalOptions_Default',
    'UIA_OutlineColorPropertyId', 'UIA_FillColorPropertyId',
    'TextUnit', 'IUIAutomationSpreadsheetPattern',
    'SynchronizedInputType_KeyDown', 'UIA_GroupControlTypeId',
    'StyleId_NumberedList', 'UIA_StylesFillColorPropertyId',
    'DockPosition', 'WindowInteractionState_BlockedByModalWindow',
    'StyleId_Heading7',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'StyleId_Emphasis', 'IUIAutomationFocusChangedEventHandler',
    'IUIAutomationScrollPattern', 'HeadingLevel3',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_AfterParagraphSpacingAttributeId', 'DockPosition_Right',
    'PropertyConditionFlags_None', 'TextEditChangeType_AutoComplete',
    'UIA_SummaryChangeId', 'OrientationType_Horizontal',
    'HeadingLevel1', 'AnnotationType_ExternalChange',
    'UIA_MarginTopAttributeId', 'AnnotationType_MoveChange',
    'UIA_SynchronizedInputPatternId', 'UIA_InvokePatternId',
    'AnnotationType_UnsyncedChange', 'UIA_DataGridControlTypeId',
    'UIA_TextEditPatternId', 'IUIAutomationTextRange3',
    'IUIAutomationElement5', 'NotificationProcessing',
    'UIA_StylesStyleIdPropertyId', 'NavigateDirection_LastChild',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_LegacyIAccessiblePatternId', 'ZoomUnit_LargeDecrement',
    'IUIAutomationTextPattern2', 'UIA_LineSpacingAttributeId',
    'IUIAutomation2', 'TextEditChangeType_None',
    'AnnotationType_Mathematics', 'UIA_HeadingLevelPropertyId',
    'RowOrColumnMajor_Indeterminate', 'UIA_FontSizeAttributeId',
    'UIA_ImageControlTypeId', 'OrientationType_Vertical',
    'StructureChangeType_ChildrenBulkRemoved',
    'IUIAutomationItemContainerPattern',
    'ProviderOptions_RefuseNonClientSupport', 'UIA_ListControlTypeId',
    'StyleId_Heading6', 'UIA_StylesShapePropertyId',
    'UIA_IsDialogPropertyId'
]

_check_version('1.2.0', 1691520278.329717)
